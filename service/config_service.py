...
def create_config(client: requests.Session, info: Config, host: str, headers: dict):
    """
...
def update_config(client: requests.Session, info: Config, host: str, headers: dict):
    """
