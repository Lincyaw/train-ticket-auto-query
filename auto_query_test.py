...
if len(sys.argv) < 2:
    ...
    # logging.fatal('No URL provided. Usage: python3 auto_query_test.py http://10.106.225.127:32059')
    logging.fatal('No URL provided. Usage: python3 auto_query_test.py http://10.104.67.224:32059')
